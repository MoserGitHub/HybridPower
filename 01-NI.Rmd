...
Suppose that the true treatment effect $\delta$ is a realization from a random variable $\Delta$ such that $\Delta \sim N\left(d, \frac{\tilde\sigma^2}{m}\right)$, where $\tilde\sigma^2=\sigma_1^2+\sigma_0^2$. This prior can be thought as a realisation from a 'prior sample' of size $m$.
...
$$
AP:=\int_{\Delta} P(S^{F}|\delta, \delta^*)p(\delta)d\delta,
$$ 

as the 'average power' @Grieve2022 (other terminologies which are often used are: assurance @OHagan2005, probability of success @Kunzmann2022, @Spiegelhalter2003).
