...
$$
\Delta|D \sim N\left(\frac{n\delta+mD}{n+m}, \frac{\sigma^2}{n+m} \right).
$$
...
$$
\begin{aligned}
D\leq -z_{1-\epsilon}&\frac{\sigma_{treat}}{\sigma_{prior}}\sqrt{\sigma^2_{treat}+\sigma^2_{prior}}+\delta^*\left(1+\frac{\sigma_{treat}}{\sigma_{prior}}\right)-\frac{\sigma^2_{treat}}{\sigma^2_{prior}}d
\end{aligned}
$$
Thus
$$
