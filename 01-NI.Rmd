...
Note that if $n_0$ and $n_1$ are the planned treatment arm sample sizes from a frequentist power calculation as described in [Section 2.1.1](###-frequentist-approach) above then
$$
