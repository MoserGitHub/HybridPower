...
From the above formula one can derive probability statements as $P(RPR>\gamma)$, from

$$
\begin{aligned}
P(RPR>\gamma)=\Phi&\left(-z_{1-\alpha}\sqrt{\frac{m(n_0\sigma_1^2+n_1\sigma_0^2)}{\sqrt{n_1n_0(\sigma_1^2+\sigma_2^2)}}}-\sqrt{\frac{m}{\sigma_1^2+\sigma_2^2}}(d-\delta^*)-\sqrt{\frac{m(n_0\sigma_1^2+n_1\sigma_0^2)}{\sqrt{n_1n_0(\sigma_1^2+\sigma_2^2)}}}\Phi^{-1}(y) \right),
\end{aligned}
$$
