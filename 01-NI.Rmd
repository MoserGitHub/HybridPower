...
$$
\begin{aligned}
P(S^B|\delta)&=\Phi\left(-z_{1-\epsilon}\frac{\sqrt{\sigma^2_{treat}+\sigma^2_{prior}}}{\sigma_{prior}^2}-\frac{1}{\sigma_{treat}}\left[\delta-\delta^*\left\{ \frac{1}{\sigma_{treat}^2}+\frac{1}{\sigma_{prior}^2} \right\} \right]-\frac{\sigma_{treat}}{\sigma_{prior}^2}d \right)
\end{aligned}
$$
